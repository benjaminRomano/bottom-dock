...
describe "BottomDock", ->
  ...
  beforeEach ->
    ...
    activationPromise = atom.packages.activatePackage('bottom-dock')

  describe "when the bottom-dock:toggle event is triggered", ->
    it "hides and shows the modal panel", ->
      ...
      runs ->
        ...
        atom.commands.dispatch workspaceElement, 'bottom-dock:toggle'
        expect(bottomDockPanel.isVisible()).toBe false
    ...
    it "hides and shows the view", ->
      ...
      runs ->
        ...
        atom.commands.dispatch workspaceElement, 'bottom-dock:toggle'
        expect(bottomDockElement).not.toBeVisible()
